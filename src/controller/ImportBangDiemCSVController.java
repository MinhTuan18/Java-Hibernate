 ...
 * @author HP
 */
public class ImportBangDiemCSVController {
    ...
    public ImportBangDiemCSVController(JLabel filenameLB, JButton openBtn, JTextField lopTF, JLabel tbLB, JButton addBtn) {
            ...
            public void mouseClicked(MouseEvent e) {
                if (file == null) {
                    ...
                    tbLB.setText("Vui lòng nhập lớp");
                        ...
                        String[] words = lopTF.getText().trim().split("-");
                        String malop = words[0];
                        String mamon = words[1];
                        boolean kq = BangdiemDAO.themBangDiemTuFileCSV(file.getAbsolutePath(), malop, mamon);
                        if (kq == true) {
