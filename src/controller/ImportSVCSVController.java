 ...
 * @author HP
 */
public class ImportSVCSVController {
    ...
    public ImportSVCSVController(JLabel filenameLB, JButton openBtn, JTextField lopTF, JLabel tbLB, JButton addBtn) {
            ...
            public void mouseClicked(MouseEvent e) {
                if (file == null) {
                    ...
                    tbLB.setText("Vui lòng nhập lớp");
                        ...
                        boolean kq = SinhvienDAO.themSVTuFileCSV(file.getAbsolutePath(), lopTF.getText().trim());
                        if (kq == true) {
